...
def search_form():
    ...
    # mid_sal_from, mid_sal_to, all_found  = sallaryfunction(sallary, spec, location)[0], sallaryfunction(sallary, spec, location)[1], sallaryfunction(sallary, spec, location)[2]
